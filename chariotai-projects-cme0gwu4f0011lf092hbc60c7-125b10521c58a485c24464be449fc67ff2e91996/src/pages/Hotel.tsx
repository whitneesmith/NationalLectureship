    ...
    <div className="bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Add Atlanta hotel/conference image */}
          <div className="mb-12">
            <img 
              src="https://images.pexels.com/photos/2833037/pexels-photo-2833037.jpeg?auto=compress&cs=tinysrgb&h=350"
              alt="Conference attendees in modern hotel setting"
